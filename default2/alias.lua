...
minetest.register_alias("blocks:desert_stonebrick", "variations:desert_stone_brick")
sc.convert_stairsplus("blocks:desert_stonebrick", "variations:desert_stone_brick")
