...
function stairs.register_stair(subname, recipeitem, groups, images, description,
	...
	if replace then
		minetest.register_node(":stairs:stair_" .. subname .. "upside_down", {
			...
			groups = {not_in_creative_inventory = 1, slabs_replace = 1},
		})
	end
...
my_register_stair_and_slab(
	"wood",
	"default:wood",
	{not_in_creative_inventory = 1, choppy = 2, oddly_breakable_by_hand = 2, flammable = 2},
	{"default_wood.png"},
	"Wooden Stair",
	"Wooden Slab",
...
my_register_stair_and_slab(
	"pine_wood",
	"default:pine_wood",
	{not_in_creative_inventory = 1, choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
...
my_register_stair_and_slab(
	"stonebrick",
	"default:stonebrick",
	{not_in_creative_inventory = 1, cracky = 2},
...
my_register_stair_and_slab(
	"sandstone",
	"default:sandstone",
	{not_in_creative_inventory = 1, crumbly = 1, cracky = 3},
...
my_register_stair_and_slab(
	"ice",
	"default:ice",
	{not_in_creative_inventory = 1, cracky = 3, cools_lava = 1, slippery = 3},
	{"default_ice.png"},
	"Ice Stair",
	"Ice Slab",
...
my_register_stair_and_slab(
	"snowblock",
	"default:snowblock",
	{not_in_creative_inventory = 1, crumbly = 3, cools_lava = 1, snowy = 1},
	{"default_snow.png"},
	"Snow Block Stair",
	"Snow Block Slab",
